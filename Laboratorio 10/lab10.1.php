...
<?php
    ...
    if(array_key_exists('enviar',$_POST)){
        ...
        if($result){
            ...
            print("<a href='http://localhost:3000/Laboratorio 10/lab10.2.php'>Ver Votos</a>\n");
...
<form action="http://localhost:3000/Laboratorio 10/lab10.1.php" method ="POST"> 
...
<a href="http://localhost:3000/Laboratorio 10/lab10.1.php">Ver Resultado</a>
